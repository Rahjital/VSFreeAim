...
namespace FreeAim
{
    public class FreeAimCore : ModSystem
    {
        ClassRegistry classRegistry;

        public static FreeAimCore clientInstance;
        public static FreeAimCore serverInstance;
        ...
        {
            classRegistry.entityBehaviorClassNameToTypeMapping["aimingaccuracy"] = typeof(FreeAim.EntityBehaviorAimingAccuracy);
            classRegistry.entityBehaviorTypeToClassNameMapping[typeof(FreeAim.EntityBehaviorAimingAccuracy)] = "aimingaccuracy";
